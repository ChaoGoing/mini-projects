...
function withResizeDetector<P, ElementT extends HTMLElement = HTMLElement>(
  ...
  class ResizeDetectorHOC extends Component<
    PropsWithoutResizeDetectorDimensions<P> & {
  ...
  function forwardRefWrapper(
    props: PropsWithoutResizeDetectorDimensions<P>,
...
type PropsWithoutResizeDetectorDimensions<P> = Without<
  Without<OptionalKey<P, "targetRef">, "width">,
  "height"
>;
